...
#SBATCH --output=/project/scro5214/1_linux/2_rnaseq/3_analysis/2_HISAT2/%j_%x.out
#SBATCH --error=/project/scro5214/1_linux/2_rnaseq/3_analysis/2_HISAT2/%j_%x.err
...
hisat2 -x /project/shared/1_linux/5_rnaseq/hisat2_index/mm10 \
--threads 12 \
-1 /project/scro5214/1_linux/2_rnaseq/1_fastq/cd4_rep1_read1.fastq.gz \
-2 /project/scro5214/1_linux/2_rnaseq/1_fastq/cd4_rep1_read2.fastq.gz \
--rna-strandness RF \
--summary-file /project/scro5214/1_linux/2_rnaseq/3_analysis/2_HISAT2/stats.txt \
-S /project/scro5214/1_linux/2_rnaseq/3_analysis/2_HISAT2/HISAT2_cd4_rep1.sam
