...
/usr/bin/time \
samtools view -b /project/scro5214/1_linux/2_rnaseq/3_analysis/2_HISAT2/HISAT2_cd4_rep1.sam > /project/scro5214/1_linux/2_rnaseq/3_analysis/3_samtools/HISAT2_cd4_rep1.bam

/usr/bin/time samtools sort /project/scro5214/1_linux/2_rnaseq/3_analysis/3_samtools/HISAT2_cd4_rep1.bam > /project/scro5214/1_linux/2_rnaseq/3_analysis/3_samtools/sorted_HISAT2_cd4_rep1.bam \
--threads 12

/usr/bin/time samtools index /project/scro5214/1_linux/2_rnaseq/3_analysis/3_samtools/sorted_HISAT2_cd4_rep1.bam \
--threads 12
