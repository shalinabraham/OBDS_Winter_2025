...
#SBATCH --output=/project/scro5214/1_linux/2_rnaseq/3_analysis/1_fastqc_slurm/%j_%x.out
#SBATCH --error=/project/scro5214/1_linux/2_rnaseq/3_analysis/1_fastqc_slurm/%j_%x.err
...
fastqc  --nogroup --threads 2 --extract -o /project/scro5214/1_linux/2_rnaseq/3_analysis/1_fastqc_slurm /project/scro5214/1_linux/2_rnaseq/1_fastq/*fastq.gz
